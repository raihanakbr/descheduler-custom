...
func (in *HighNodeUtilizationArgs) DeepCopyInto(out *HighNodeUtilizationArgs) {
	*out = *in
	...
	if in.NetworkAware != nil {
		in, out := &in.NetworkAware, &out.NetworkAware
		*out = new(NetworkAwareConfig)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto writes a deep copy of NetworkAwareConfig into out.
func (in *NetworkAwareConfig) DeepCopyInto(out *NetworkAwareConfig) {
	*out = *in
...
// DeepCopy returns a deep copy of NetworkAwareConfig.
func (in *NetworkAwareConfig) DeepCopy() *NetworkAwareConfig {
	if in == nil {
		return nil
	}
	out := new(NetworkAwareConfig)
